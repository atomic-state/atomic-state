    ...
    var initialized = (0, react_1.useMemo)(function () {
        return createdAtoms.map(function (atm) {
            return (react_1.default.createElement(react_1.default.StrictMode, { key: (atm === null || atm === void 0 ? void 0 : atm.name) + prefix + thisId },
                react_1.default.createElement(AtomInitialize, { atm: atm, key: (atm === null || atm === void 0 ? void 0 : atm.name) + prefix + thisId })));
        });
    }, [createdAtoms]);
...
function useAtomCreate(init) {
    ...
    var _f = (0, react_1.useState)((_isPromise(initialValue) || _isFunction(initialValue)) &&
        !_isDefined(defaultAtomsValues[$atomKey])
        ? undefined
        : (function () {
    ...
    var updateState = (0, react_1.useCallback)(function (v) {
        ...
        var notifyIfValueIsDefault = (function () {
            try {
                ...
                if (jsonEquality(newValue, init.default) &&
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.trys.push([1, 4, , 5]);
                            if (!!jsonEquality(localStorage[$atomKey], defaultAtomsValues[$atomKey])) return [3 /*break*/, 3];
