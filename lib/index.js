...
function AtomInitialize(_a) {
    var atm = _a.atm;
    var used = useAtom(atm);
    return null;
}
function FilterInitialize(_a) {
    var filt = _a.filt;
    var used = useFilter(filt);
    return null;
}
var AtomicState = function (_a) {
    ...
    var initialized = (0, react_1.useMemo)(function () {
        return createdAtoms.map(function (atm) {
            return react_1.default.createElement(AtomInitialize, { key: (atm === null || atm === void 0 ? void 0 : atm.name) + prefix, atm: atm });
        });
    }, []);
    ...
    var initializedFilters = (0, react_1.useMemo)(function () {
        return createdFilters.map(function (flt) {
            return react_1.default.createElement(FilterInitialize, { key: (flt === null || flt === void 0 ? void 0 : flt.name) + prefix, filt: flt });
        });
    }, []);
...
function useAtomCreate(init) {
    ...
    var updateState = (0, react_1.useCallback)(function (v) {
        ...
        newValue =
            typeof v === "function" ? v(defaultAtomsValues[$atomKey]) : v;
        hasChanded = (function () {
            try {
...
function filter(init) {
    ...
    if (!filtersInitializeObjects[init === null || init === void 0 ? void 0 : init.name]) {
    ...
    var useFilterGet = function () {
        ...
        var _a = (0, react_1.useState)(function () {
            return initialValue instanceof Promise || typeof initialValue === "undefined"
                ? init.default
                : (function () {
                    ...
                    if (typeof e.payload === "function"
                        ...
                        try {
                            if (!$resolving[$filterKey]) {
                                ...
                                tm_1 = setTimeout(function () { return __awaiter(_this, void 0, void 0, function () {
                                    var newValue, _a;
                                    return __generator(this, function (_b) {
                                        switch (_b.label) {
                                            case 0:
                                            ...
                                            case 3:
                                                ...
                                                if (typeof newValue === "function") {
                                                    setFilterValue(function () { return newValue; });
                                                }
                                                else {
                ...
                return __generator(this, function (_a) {
                    ...
                    if (hookCall !== e.hookCall) {
                        if (typeof payload === "function") {
                            setFilterValue(function () { return payload; });
                        }
                        else {
