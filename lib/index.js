        ...
        try {
            return (function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, localStorage.getItem($atomKey)];
                        case 1:
                            storageItem = _a.sent();
                            return [2 /*return*/, JSON.parse(storageItem) || init.default];
                    }
                });
            }); })();
        }
    ...
    var useFilterGet = function () {
        ...
        var getObject = (0, react_1.useMemo)(function () { return ({
            get: function (atom) {
                ...
                if (typeof atom !== "function") {
                    filterDeps[prefix]["".concat(prefix, "-").concat(atom.name)] = true;
                    ...
                    filterDeps[prefix]["".concat(prefix, "-").concat(atom["atom-name"])] = true;
                            ...
                            tm_1 = setTimeout(function () { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        case 0:
                                            if (!(e.storeName in filterDeps[prefix] ||
                                                !("addEventListener" in window))) return [3 /*break*/, 2];
        ...
        (0, react_1.useEffect)(function () {
            ...
            if (!subscribedFilters[$filterKey]) {
                ...
                for (var dep in filterDeps[prefix]) {
